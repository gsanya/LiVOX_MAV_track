...
param1_values=(0.4 0.5 0.6)
param2_values=(0.4 0.5 0.6)
param3_values=(0.0 0.05 0.1 0.15 0.2)
param4_values=(0.1 0.2 0.3)
param5_values=(5000)
...
# Bag file to play
BAG_FILE="/home/appuser/_Datasets/livox_mav_track/outside/horizontal_fast.bag"

# Topics to record
RECORD_TOPICS="/mav_track/mav_marker"

# Output directory
OUTPUT_DIR="/home/appuser/livox_mav_track/scripts/results/grid_search_stds"
mkdir -p "$OUTPUT_DIR"
      ...
      for p4 in "${param4_values[@]}"; do
        for p5 in "${param5_values[@]}"; do          
          for run in $(seq 1 $REPEAT); do
            ...
            rosbag play "$BAG_FILE" --start 22.0 --clock 
